...
const nameInputforEdit = document.querySelector('.popup__field_type_name_type_edit');
const jobInputforEdit = document.querySelector('.popup__field_type_job_type_edit');
const nameInputforAdd = document.querySelector('.popup__field_type_name_type_add');
const jobInputforAdd = document.querySelector('.popup__field_type_job_type_add');
...
const popupFotoElementforImage = document.querySelector('.image-profile__foto');
