...
function setSubmitButtonStatus(form) {
    ...
    if (isValid) {
        ...
        button.classList.remove('popup__button-type_invalid');
        button.classList.add('popup__button-type_valid');
    } else {
        button.setAttribute('disabled', true);
        button.classList.add('popup__button-type_invalid');
        button.classList.remove('popup__button-type_valid');
    }
}
